...
App = {
    ...
    screen : {size:{},percent:{x:null,y:null}},
    menu_is_open : false,
    ...
    fr_LastPos : {x : 0,y :0},
    lastOrientation : {beta:0, gamma:0},
    socket : {},
    keyModifiers : [],
    ...
    init: function(){
        ...
        App.socket.on('initScreen',(screenSize)=>{
            App.screen.size = screenSize;
            App.screen.percent.x = screenSize.width * 0.1;
            App.screen.percent.y = screenSize.height * 0.1;
        });
    ...
    orientationChange : function(event){
        ...
        if(App.calcType == 'magic'){
            ...
            let y  = event.beta / 18;
            App.socket.emit('motionChange',obj);
